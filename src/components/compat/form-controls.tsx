...
/** @deprecated These labelled native controls are compatibility adapters. Use Field plus components/ui controls for new code. */
...
function FieldFrame({ id, label, helper, error, children }: FieldFrameProps) {
  ...
  return (
    <div className="grid gap-2 text-sm">
      <label htmlFor={id} className="mw-meta text-muted-foreground">{label}</label>
      {children}
      {message ? (
