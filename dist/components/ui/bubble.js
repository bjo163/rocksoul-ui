...
var a = r("group/bubble relative flex w-fit max-w-[80%] min-w-0 flex-col gap-1 group-data-[align=end]/message:self-end data-[align=end]:self-end data-[variant=ghost]:max-w-full", {
	variants: { variant: {
...
function o({ variant: n = "default", align: r = "start", className: i, ...o }) {
	return /* @__PURE__ */ t("div", {
		"data-slot": "bubble",
		"data-variant": n,
		"data-align": r,
		className: e(a({ variant: n }), i),
		...o
	});
}
function s({ asChild: r = !1, className: i, ...a }) {
	let o = r ? n.Root : "div";
	return /* @__PURE__ */ t(o, {
		"data-slot": "bubble-content",
		className: e("w-fit max-w-full min-w-0 overflow-hidden rounded-none border border-transparent px-3 py-2 text-sm leading-relaxed wrap-break-word group-data-[align=end]/bubble:self-end [button]:text-left [button,a]:transition-colors [button,a]:outline-none [button,a]:focus-visible:border-ring [button,a]:focus-visible:ring-3 [button,a]:focus-visible:ring-ring/50", i),
		...a
	});
}
var c = r("absolute z-10 flex w-fit shrink-0 items-center justify-center gap-1 rounded-full bg-muted px-1.5 py-0.5 text-sm ring-3 ring-card has-[button]:p-0", {
	variants: {
		side: {
...
function l({ side: n = "bottom", align: r = "end", className: i, ...a }) {
	return /* @__PURE__ */ t("div", {
