...
function g({ className: t, ...n }) {
	return /* @__PURE__ */ l(f.Clear, {
		...
		className: e(t),
		...n,
		children: /* @__PURE__ */ l(r, { className: "pointer-events-none" })
	});
}
function _({ className: t, children: n, disabled: r = !1, showTrigger: i = !0, showClear: d = !1, ...p }) {
	return /* @__PURE__ */ u(a, {
		className: e("w-auto", t),
		children: [
			/* @__PURE__ */ l(f.Input, {
				render: /* @__PURE__ */ l(c, { disabled: r }),
				...p
			}),
			/* @__PURE__ */ u(o, {
				align: "inline-end",
				children: [i && /* @__PURE__ */ l(s, {
					size: "icon-xs",
					variant: "ghost",
					asChild: !0,
...
function b({ className: n, children: r, ...i }) {
	return /* @__PURE__ */ u(f.Item, {
		...
		...i,
		children: [r, /* @__PURE__ */ l(f.ItemIndicator, {
			"data-slot": "combobox-item-indicator",
			render: /* @__PURE__ */ l("span", { className: "pointer-events-none absolute right-2 flex size-4 items-center justify-center" }),
			children: /* @__PURE__ */ l(t, { className: "pointer-events-none size-4 pointer-coarse:size-5" })
		})]
	});
}
...
function D({ className: t, children: n, showRemove: a = !0, ...o }) {
	return /* @__PURE__ */ u(f.Chip, {
		...
		...o,
		children: [n, a && /* @__PURE__ */ l(f.ChipRemove, {
			render: /* @__PURE__ */ l(i, {
				variant: "ghost",
				size: "icon-xs"
			}),
