...
function u({ orientation: t = "horizontal", opts: n, setApi: r, plugins: o, className: l, children: u, ...d }) {
	let [f, p] = s({
		...n,
		axis: t === "horizontal" ? "x" : "y"
	}, o), [m, h] = i.useState(!1), [g, _] = i.useState(!1), v = i.useCallback((e) => {
...
function p({ className: n, variant: i = "outline", size: s = "icon", ...c }) {
...
function m({ className: t, variant: i = "outline", size: s = "icon", ...c }) {
