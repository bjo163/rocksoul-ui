...
var c = a.forwardRef(({ className: a, value: c, defaultValue: l, onClear: u, clearLabel: d = "Clear search", ...f }, p) => {
	let m = c === void 0 ? l !== void 0 && String(l).length > 0 : String(c).length > 0;
	return /* @__PURE__ */ s("div", {
		className: "relative w-full",
		"data-slot": "search-input",
		children: [
			/* @__PURE__ */ o(t, { className: "pointer-events-none absolute left-3 top-1/2 size-4 -translate-y-1/2 text-muted-foreground" }),
			/* @__PURE__ */ o(i, {
				ref: p,
				type: "search",
				value: c,
				defaultValue: l,
				className: e("pl-9", m && u && "pr-9", a),
				...f
			}),
			m && u ? /* @__PURE__ */ o(r, {
				type: "button",
				...
				onClick: u,
				"aria-label": d,
				children: /* @__PURE__ */ o(n, { className: "size-4" })
			}) : null
		]
	});
});
