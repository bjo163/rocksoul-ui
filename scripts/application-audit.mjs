...
const shell = await readFile(path.join(src, "components", "application-shell.tsx"), "utf8")
const screens = await readFile(path.join(src, "screens", "application-screens.tsx"), "utf8")
const stories = await readFile(path.join(src, "stories", "V2Screens.stories.tsx"), "utf8")
const archive = await readFile(path.join(src, "components", "archive-components.tsx"), "utf8")
