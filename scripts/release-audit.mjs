...
if(!assetsContract.includes("assetPackCount: 42")) failures.push("42 asset packs")
if(!assetsContract.includes("canonicalAssetCount: 614")) failures.push("614 canonical assets")
